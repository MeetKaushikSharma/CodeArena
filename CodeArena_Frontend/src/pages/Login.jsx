  ...
  return (
    <div className="min-h-screen bg-[#0b0b10] text-white flex overflow-hidden">
      ...
      {CODE_SNIPPETS.map((s, i) => (
        <div
          key={i}
          className="fixed font-mono text-xs text-indigo-300 pointer-events-none select-none hidden lg:block"
          style={{
            top: s.top,
            left: s.left,
            right: s.right,
      ...
      <div className="hidden lg:flex flex-col w-[45%] relative border-r border-white/[0.04] p-12 justify-between ml-10 mb-10">
        ...
        <div>
          ...
          <p className="text-zinc-500 text-sm leading-relaxed max-w-xs">
            Practice coding challenges, compete with others, and land your dream
            job.
          </p>
      ...
      <div className="flex-1 flex items-center justify-center p-6 relative mt-20">
        <div className="w-full max-w-sm">
          ...
          {/* Signup link */}
          <p className="text-center text-sm text-zinc-600 mt-5 fade-up-5">
