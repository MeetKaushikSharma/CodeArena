        ...
        <div className="w-full max-w-sm mt-20">
          ...
          <div className="mb-7 fu1">
            ...
            <p className="text-zinc-500 text-sm mt-1">
              Start solving problems for free
            </p>
          </div>
                        ...
                        return (
                          <div
                            ...
                            className={
                              ...
                              (met ? "text-emerald-400" : "text-zinc-700")
                            }
                          >
      ...
      <div className="hidden lg:flex flex-col w-[42%] relative border-l border-white/[0.04] p-12 justify-between bg-white/[0.008] mr-5 mb-18">
        ...
        <div className="mb-40">
          ...
          <p className="text-zinc-500 text-sm leading-relaxed mb-8 max-w-xs">
            Practice with real interview questions, get AI hints, watch
            editorial videos, and track your progress.
          </p>
